...
void Intake::LoadingInit()
{
    ProcessStickySwitches();
    GetSensorPressed(Intake::SensorLocation::NewPowercell);
    GetSensorPressed(Intake::SensorLocation::SecuredPowercell);
